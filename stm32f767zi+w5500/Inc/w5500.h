...
uint16_t w5500_getReadPointer(void);
uint16_t w5500_getWritePointer(void);
uint16_t w5500_getTXFreeSize(void);
uint8_t w5500_getTXBufSize(void);

uint16_t w5500_getRXReceivedSize(void);
